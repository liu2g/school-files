...
from settings import SIZES, H3P2_NN, HIDDEN_NEURONS, MAX_EPOCHS, VALI_R, PATIENCE
...
network.train(train_db['x'], train_db['x'],learning_rate = 0.01, 
              ...
              threshold=0, validation_ratio=VALI_R, earlystop=(1E-2,PATIENCE),
               weight_decay=1E-5,
              )
network.save(H3P2_NN)
